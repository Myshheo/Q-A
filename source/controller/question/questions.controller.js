import {QuestionsService} from "../../service/question/questions.service"
...
export class QuestionsController{
    ...
    findAllQuetions = async(req,res,next)=>{
        try{
    ...
    updateQuestion = async (req,res,next)=>{
        ...
        try{
            ...
            res.status(updatedQuestion.status).json(updatedQuestion);
        }catch(error){
            next(error);
        }
    };
